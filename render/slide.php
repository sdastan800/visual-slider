...
class visualslider_carousel extends WPBakeryShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		if ( $the_query->have_posts() ) { ?>
			<section class="slider post-slider vc-post-styling" data-slick='{"arrows": <?php echo esc_attr($arrow); ?>, "autoplaySpeed": <?php echo esc_attr($speed); ?>, "dots": <?php echo esc_attr($dot); ?>, "autoplay": <?php echo esc_attr($autoplay); ?>, "slidesToShow": <?php echo esc_attr($slide_visible); ?>, "slidesToScroll": <?php echo esc_attr($slide_scroll); ?>}'>
...
vc_map( array(
	...
	"name" 			=> __( 'Post Carousel', 'visualslider' ),
	...
	'params' => array(
		...
		array(
			...
			"param_name" 	=> 	"height",
			"description"	=>	__('post image height, set in pixel', 'visualslider'),
			"group" 		=> 'Settings',
			"value"			=>	"200px",
		),
		array(
		...
		array(
			"type" 			=> 	"dropdown",
			"heading" 		=> 	__( 'Arrows', 'visualslider' ),
			"param_name" 	=> 	"arrow",
			"description"	=>	__('Show/Hide on left & right', 'visualslider'),
			"group" 		=> 'Settings',
				"value" 		=> 	array(
					"Show" 			=> 		"true",
					"Hide" 			=> 		"false",
		...
		array(
			"type" 			=> 	"dropdown",
			"heading" 		=> 	__( 'Dots', 'visualslider' ),
			"param_name" 	=> 	"dot",
			"description"	=>	__('Show/Hide show at bottom', 'visualslider'),
			"group" 		=> 'Settings',
				"value" 		=> 	array(
					"Show" 			=> 		"true",
					"Hide" 			=> 		"false",
		...
		array(
			"type" 			=> 	"dropdown",
			"heading" 		=> 	__( 'Autoplay', 'visualslider' ),
			"param_name" 	=> 	"autoplay",
			"description"	=>	__('move auto or slide on click', 'visualslider'),
			"group" 		=> 'Settings',
			"value" 		=> 	array(
				"True" 		=> 		"true",
				"False" 	=> 		"false",
		...
		array(
			"type" 			=> 	"textfield",
			"heading" 		=> 	__( 'Slider Speed', 'visualslider' ),
			"param_name" 	=> 	"speed",
			"description"	=>	__('write in ms eg, 1500 [1s = 1000]', 'visualslider'),
			"value"			=>	"1500",
			"group" 		=> 'Settings',
		),
		array(
			"type" 			=> 	"textfield",
			"heading" 		=> 	__( 'Slide To Show', 'visualslider' ),
			"param_name" 	=> 	"slide_visible",
			"description"	=>	__('set visible number of slides. default is 3', 'visualslider'),
			"value"			=>	"3",
			"group" 		=> 'Settings',
		),
		array(
			"type" 			=> 	"textfield",
			"heading" 		=> 	__( 'Slide To Scroll', 'visualslider' ),
			"param_name" 	=> 	"slide_scroll",
			"description"	=>	__('allow user to multiple slide on click or drag. default is 1', 'visualslider'),
			"value"			=>	"1",
			"group" 		=> 'Settings',
		),
